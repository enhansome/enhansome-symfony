...
* [TablerBundle](https://github.com/kevinpapst/TablerBundle) ⭐ 133 | 🐛 13 | 🌐 Twig | 📅 2026-09-15 - Admin theme based on the Tabler Template. It ships with many twig helpers (functions, filter, embeds, macros and includes).
* [EasyAdminBundle](https://github.com/javiereguiluz/EasyAdminBundle) ⭐ 22 | 🐛 0 | 🌐 PHP | 📅 2026-09-15 - Simple admin generator for Symfony applications
...
* [Sylius](https://github.com/Sylius/Sylius) ⭐ 8,535 | 🐛 227 | 🌐 PHP | 📅 2026-09-16 - E-Commerce PHP framework built on top of Symfony with component-based architecture and format-agnostic rendering
...
* [Symfony Recipes](https://github.com/symfony/recipes) ⭐ 1,027 | 🐛 47 | 🌐 PHP | 📅 2026-09-16 - Symfony recipes allow the automation of Composer packages configuration via the Symfony Flex Composer plugin.
* [Symfony Recipes (Contrib)](https://github.com/symfony/recipes-contrib) ⭐ 559 | 🐛 1 | 🌐 PHP | 📅 2026-09-16 - Symfony recipes allow the automation of Composer packages configuration via the Symfony Flex Composer plugin.
...
* [CraueConfigBundle](https://github.com/craue/CraueConfigBundle) ⭐ 175 | 🐛 4 | 🌐 PHP | 📅 2026-09-16 - Manages configuration settings stored in the database and makes them accessible via a service in your Symfony 2 project.
...
* [DoctrineFixturesBundle](https://github.com/doctrine/DoctrineFixturesBundle) ⭐ 2,532 | 🐛 29 | 🌐 PHP | 📅 2026-09-16 - Integrates the Doctrine2 Data Fixtures library.
...
* [DunglasApiBundle](https://github.com/dunglas/DunglasApiBundle) ⭐ 2,574 | 🐛 240 | 🌐 PHP | 📅 2026-09-16 - Bundle to build hypermedia-driven REST API.
* [NelmioApiDocBundle](https://github.com/nelmio/NelmioApiDocBundle) ⭐ 2,367 | 🐛 54 | 🌐 PHP | 📅 2026-09-14 - Generates documentation for your REST API from annotations.
