...
* [EasyAdminBundle](https://github.com/javiereguiluz/EasyAdminBundle) ⭐ 22 | 🐛 0 | 🌐 PHP | 📅 2026-09-16 - Simple admin generator for Symfony applications
...
* [Sylius](https://github.com/Sylius/Sylius) ⭐ 8,535 | 🐛 232 | 🌐 PHP | 📅 2026-09-17 - E-Commerce PHP framework built on top of Symfony with component-based architecture and format-agnostic rendering
...
* [Symfony Recipes (Contrib)](https://github.com/symfony/recipes-contrib) ⭐ 559 | 🐛 3 | 🌐 PHP | 📅 2026-09-17 - Symfony recipes allow the automation of Composer packages configuration via the Symfony Flex Composer plugin.
...
* [DunglasApiBundle](https://github.com/dunglas/DunglasApiBundle) ⭐ 2,574 | 🐛 241 | 🌐 PHP | 📅 2026-09-17 - Bundle to build hypermedia-driven REST API.
* [NelmioApiDocBundle](https://github.com/nelmio/NelmioApiDocBundle) ⭐ 2,368 | 🐛 56 | 🌐 PHP | 📅 2026-09-14 - Generates documentation for your REST API from annotations.
