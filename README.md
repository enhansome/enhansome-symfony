...
* [EasyAdminBundle](https://github.com/javiereguiluz/EasyAdminBundle) ⭐ 22 | 🐛 0 | 🌐 PHP | 📅 2026-09-14 - Simple admin generator for Symfony applications
...
* [Sylius](https://github.com/Sylius/Sylius) ⭐ 8,534 | 🐛 227 | 🌐 PHP | 📅 2026-09-10 - E-Commerce PHP framework built on top of Symfony with component-based architecture and format-agnostic rendering
...
* [Symfony Recipes](https://github.com/symfony/recipes) ⭐ 1,028 | 🐛 47 | 🌐 PHP | 📅 2026-09-09 - Symfony recipes allow the automation of Composer packages configuration via the Symfony Flex Composer plugin.
* [Symfony Recipes (Contrib)](https://github.com/symfony/recipes-contrib) ⭐ 559 | 🐛 6 | 🌐 PHP | 📅 2026-09-15 - Symfony recipes allow the automation of Composer packages configuration via the Symfony Flex Composer plugin.
...
* [CraueConfigBundle](https://github.com/craue/CraueConfigBundle) ⭐ 175 | 🐛 4 | 🌐 PHP | 📅 2026-09-15 - Manages configuration settings stored in the database and makes them accessible via a service in your Symfony 2 project.
...
* [DunglasApiBundle](https://github.com/dunglas/DunglasApiBundle) ⭐ 2,574 | 🐛 239 | 🌐 PHP | 📅 2026-09-15 - Bundle to build hypermedia-driven REST API.
