...
* [SonataAdminBundle](https://github.com/sonata-project/SonataAdminBundle) ⭐ 2,126 | 🐛 17 | 🌐 PHP | 📅 2026-06-04 - AdminBundle - The missing Symfony2 Admin Generator
...
* [API Platform framework](https://github.com/api-platform/api-platform) ⭐ 9,183 | 🐛 2 | 🌐 PHP | 📅 2026-09-01
...
* [Sylius](https://github.com/Sylius/Sylius) ⭐ 8,527 | 🐛 224 | 🌐 PHP | 📅 2026-09-10 - E-Commerce PHP framework built on top of Symfony with component-based architecture and format-agnostic rendering
...
* [LiipImagineBundle](https://github.com/liip/LiipImagineBundle) ⭐ 1,708 | 🐛 82 | 🌐 PHP | 📅 2026-09-06 - Image manipulation bundle, based on Imagine library.
...
* [EightPointsGuzzleBundle](https://github.com/8p/EightPointsGuzzleBundle) ⭐ 445 | 🐛 15 | 🌐 PHP | 📅 2026-09-01 - Integrates Guzzle 6.x, a PHP HTTP Client, into Symfony 2-4 and provides plugins to extend basic functionality.
...
* [metrics](https://github.com/beberlei/metrics) ⭐ 332 | 🐛 0 | 🌐 PHP | 📅 2026-09-09 - Simple library that abstracts different metrics collectors.
...
* [TbbcMoneyBundle](https://github.com/TheBigBrainsCompany/TbbcMoneyBundle) ⭐ 196 | 🐛 1 | 🌐 PHP | 📅 2026-05-04 - This bundle is used to integrate the Money library from mathiasverraes into a symfony2 project.
...
* [Symfony Recipes](https://github.com/symfony/recipes) ⭐ 1,027 | 🐛 45 | 🌐 PHP | 📅 2026-09-09 - Symfony recipes allow the automation of Composer packages configuration via the Symfony Flex Composer plugin.
* [Symfony Recipes (Contrib)](https://github.com/symfony/recipes-contrib) ⭐ 559 | 🐛 4 | 🌐 PHP | 📅 2026-09-09 - Symfony recipes allow the automation of Composer packages configuration via the Symfony Flex Composer plugin.
...
* [DoctrineMigrationsBundle](https://github.com/doctrine/DoctrineMigrationsBundle) ⭐ 4,301 | 🐛 43 | 🌐 PHP | 📅 2026-08-31 - Integrates the Doctrine2 Migrations library.
...
* [DunglasApiBundle](https://github.com/dunglas/DunglasApiBundle) ⭐ 2,574 | 🐛 282 | 🌐 PHP | 📅 2026-09-09 - Bundle to build hypermedia-driven REST API.
